...
@section('content')
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6">
            <h1 class="text-3xl font-bold text-gray-800 mb-4 sm:mb-0">Student List</h1>
        ...
        <div class="flex flex-wrap gap-2 mb-6">
            <a href="{{ route('students.create') }}"
               class="inline-block bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-md font-semibold shadow transition">Add Student</a>
            <a href="{{ route('study-programs.index') }}"
               class="inline-block bg-yellow-500 hover:bg-yellow-600 text-white px-4 py-2 rounded-md font-semibold shadow transition">List Study Program</a>
        </div>
            ...
            <table class="min-w-full bg-white shadow-md rounded-lg overflow-hidden">
                <thead class="bg-gray-100 text-gray-700">
                    <tr>
                        ...
                        <th class="px-4 py-3 text-left">Study Program</th>
