...
<div class="container mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <form action="{{ route('students.update', $student->id) }}" method="POST" class="space-y-6 bg-white p-6">
        @csrf
        @method('PATCH')
        ...
        <div>
            ...
            <input type="text" name="name" id="name"
                ...
                placeholder="John Doe" value="{{ old('name', $student->name) }}" required>
            @error('name')
        ...
        <div>
            ...
            <input type="text" name="student_number" id="student_number"
                ...
                placeholder="2021001234" value="{{ old('student_number', $student->student_number) }}" required>
        ...
        <div>
            ...
            <input type="email" name="email" id="email"
                ...
                placeholder="student@email.com" value="{{ old('email', $student->email) }}" required>
            @error('email')
                <p class="text-sm text-red-600 mt-1">{{ $message }}</p>
            @enderror
        </div>
